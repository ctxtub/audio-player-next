...
import HistoryRecords, {
  HistoryRecordsRef,
} from "@/app/home/components/HistoryRecords";
import {
...
const InputStatusSection: React.FC<InputStatusSectionProps> = ({
  ...
  return (
    <div className="surface-card mb-sm flex flex-col gap-3 overflow-hidden p-md">
      <div className="flex max-h-[var(--size-max-height-prompt-panel)] flex-col gap-1 transition-transform duration-theme ease-theme">
        <div className="mb-sm grid grid-cols-3 gap-sm">
          ...
          <button
            className="btn-chip btn-chip--history"
        ...
        <div className="flex w-full items-stretch rounded-xl shadow-surface-sm">
          <textarea
            value={textareaInput}
          ...
          />
          <button
            className="btn-primary relative -ml-px min-w-[var(--size-min-width-button)] rounded-r-xl rounded-l-none"
            onClick={onSubmit}
            disabled={isSubmitting}
          >

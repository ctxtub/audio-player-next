/**
 * M8-04 Canonical Audio Feature Flag（spec §39；M8-04）。
 *
 ...
 * M8-05 CLOSED 前生产不得默认开启；M8-04 允许 test / explicit environment 开启：
 ...
 *
 * M8-04 browser targeted 运行时覆盖：E2E harness 构建为单快照（全场景共享

...
// 中文注释：套件注册表（51 项，id 由 path 推导剥后缀，group 按迁移表归类，needs_db 仅 unit 与无库 tooling 元测试为 false）。
...
const SUITES = [
    ...
    { id: 'login-existing-no-leak', path: './tests/integration/identity-session/login-existing-no-leak.integration.test.ts', group: 'integration', needs_db: true },
    { id: 'logout-dual-cookie-clean-reset', path: './tests/integration/identity-session/logout-dual-cookie-clean-reset.integration.test.ts', group: 'integration', needs_db: true },
    ...
    { id: 'playback-session-contract', path: './tests/unit/playback/playback-session-contract.unit.test.ts', group: 'unit', needs_db: false },
    ...
    { id: 'playback-lifecycle-trash', path: './tests/integration/playback/playback-lifecycle-trash.integration.test.ts', group: 'integration', needs_db: true },
    ...
    { id: 'storycard-session-resume', path: './tests/unit/playback/storycard-session-resume.unit.test.ts', group: 'unit', needs_db: false },
    { id: 'storycard-session-flow', path: './tests/integration/playback/storycard-session-flow.integration.test.ts', group: 'integration', needs_db: true },
    ...
    { id: 'audio-manifest-identity', path: './tests/unit/audio/audio-manifest-identity.unit.test.ts', group: 'unit', needs_db: false },
    { id: 'audio-storage', path: './tests/unit/audio/audio-storage.unit.test.ts', group: 'unit', needs_db: false },
    ...
    { id: 'audio-lifecycle-delete', path: './tests/unit/audio/audio-lifecycle-delete.unit.test.ts', group: 'unit', needs_db: false },
    { id: 'audio-lifecycle-delete-integration', path: './tests/integration/audio/audio-lifecycle-delete-integration.integration.test.ts', group: 'integration', needs_db: true },
    { id: 'audio-ownership-transfer', path: './tests/unit/audio/audio-ownership-transfer.unit.test.ts', group: 'unit', needs_db: false },
    ...
    { id: 'library-list-read-ui', path: './tests/unit/persistence-config/library-list-read-ui.unit.test.ts', group: 'unit', needs_db: false },
    { id: 'library-list-lifecycle-undo', path: './tests/unit/persistence-config/library-list-lifecycle-undo.unit.test.ts', group: 'unit', needs_db: false },
    ...
    { id: 'story-artifact-promotion', path: './tests/unit/creation-chat/story-artifact-promotion.unit.test.ts', group: 'unit', needs_db: false },
    ...
    { id: 'expanded-playback-capabilities', path: './tests/unit/now-playing/expanded-playback-capabilities.unit.test.ts', group: 'unit', needs_db: false },
    ...
    { id: 'creation-actions', path: './tests/unit/now-playing/creation-actions.unit.test.ts', group: 'unit', needs_db: false },
    ...
    { id: 'm10-browser-debt-closure', path: './tests/unit/navigation/m10-browser-debt-closure.unit.test.ts', group: 'unit', needs_db: false },
    ...
    { id: 'sleep-timer-session', path: './tests/integration/playback/sleep-timer-session.integration.test.ts', group: 'integration', needs_db: true },

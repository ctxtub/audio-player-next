...
export const userConfigPatchSchema = z
    .object({
        ...
        /** 是否在宽屏启用悬浮迷你播放器（ 正式语义；false=wide-docked）。 */

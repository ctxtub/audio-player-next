 ...
 *    严禁绕过基底裸调 prisma.storyWork.delete / deleteMany；该基底函数为后续  对象存储音频清理的唯一 Service Seam；
 ...
 *    并保证  Audio tombstone 记录与音频清理仅挂载于基底 primitive 一处。
 *
